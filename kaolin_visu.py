...
if __name__ == "__main__":
    ...
    for f in obj_files:
        ...
        face_list.append(res.faces.cuda())
        gt_vert_list.append(vertices.cuda())
    ...
    # vox = kaolin.ops.conversions.trianglemeshes_to_voxelgrids(
    #             gt_vert_list[-1].unsqueeze(0), face_list[0], 30).bool()
